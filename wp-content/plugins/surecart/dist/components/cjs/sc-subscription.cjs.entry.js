...
const ScSubscription = class {
  ...
  renderContent() {
    ...
    return (index.h(index.Fragment, null, index.h("sc-subscription-next-payment", { subscription: this.subscription }, index.h("sc-subscription-details", { subscription: this.subscription }))));
  }
  render() {
    var _a, _b, _c, _d, _e, _f;
    return (index.h("sc-dashboard-module", { heading: this.heading || wp.i18n.__('Current Plan', 'surecart'), class: "subscription", error: this.error }, !!this.subscription && (index.h("sc-flex", { slot: "end", class: "subscription__action-buttons" }, this.updatePaymentMethodUrl && (index.h("sc-button", { type: "link", href: this.updatePaymentMethodUrl }, index.h("sc-icon", { name: "credit-card", slot: "prefix" }), wp.i18n.__('Update Payment Method', 'surecart'))), !!Object.keys((_a = this.subscription) === null || _a === void 0 ? void 0 : _a.pending_update).length && (index.h("sc-button", { type: "link", onClick: () => this.cancelPendingUpdate() }, index.h("sc-icon", { name: "x-octagon", slot: "prefix" }), wp.i18n.__('Cancel Scheduled Update', 'surecart'))), ((_b = this === null || this === void 0 ? void 0 : this.subscription) === null || _b === void 0 ? void 0 : _b.cancel_at_period_end) ? (index.h("sc-button", { type: "link", onClick: () => this.renewSubscription() }, index.h("sc-icon", { name: "repeat", slot: "prefix" }), wp.i18n.__('Restore Plan', 'surecart'))) : (((_c = this.subscription) === null || _c === void 0 ? void 0 : _c.status) !== 'canceled' &&
      ((_d = this.subscription) === null || _d === void 0 ? void 0 : _d.current_period_end_at) &&
      this.showCancel && (index.h("sc-button", { type: "link", onClick: () => (this.cancelModal = true) }, index.h("sc-icon", { name: "x", slot: "prefix" }), wp.i18n.__('Cancel Plan', 'surecart')))), ((_e = this.subscription) === null || _e === void 0 ? void 0 : _e.status) === 'canceled' && (index.h("sc-button", { type: "link", ...(!!((_f = this.subscription) === null || _f === void 0 ? void 0 : _f.payment_method)
        ? {
          onClick: () => (this.resubscribeModal = true),
        }
        : {
          href: addQueryArgs.addQueryArgs(window.location.href, {
