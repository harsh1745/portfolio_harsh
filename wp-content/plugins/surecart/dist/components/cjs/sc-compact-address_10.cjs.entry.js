...
const mutations$1 = require('./mutations-82184fe2.js');
const index$3 = require('./index-fe47fecc.js');
const getters = require('./getters-60e414dc.js');
const getters$1 = require('./getters-1e382cac.js');
const mutations$3 = require('./mutations-f436c5a9.js');
const mutations$2 = require('./mutations-d667611b.js');
...
const ScOrderBump = class {
  ...
  render() {
    ...
    return (index.h("sc-choice", { value: (_c = this.bump) === null || _c === void 0 ? void 0 : _c.id, type: "checkbox", showControl: this.showControl, checked: index$2.isBumpInOrder(this.bump, mutations.state === null || mutations.state === void 0 ? void 0 : mutations.state.checkout), onScChange: e => this.updateLineItem(e.target.checked), onKeyDown: e => {
        if (e.key === 'Enter' || e.key === ' ') {
          e.preventDefault();
          e.stopImmediatePropagation();
          this.updateLineItem(!index$2.isBumpInOrder(this.bump, mutations.state === null || mutations.state === void 0 ? void 0 : mutations.state.checkout));
        }
...
const ScOrderShippingAddress = class {
  ...
  async updateAddressState(address) {
    ...
    try {
      ...
      mutations.state.checkout = (await index$3.createOrUpdateCheckout({
  ...
  render() {
    ...
    if (getters.fullShippingAddressRequired() || this.full || this.requireName || this.showName) {
      return (index.h("sc-address", { exportparts: "label, help-text, form-control, input__base, select__base, columns, search__base, menu__base", ref: el => (this.input = el), label: this.label || wp.i18n.__('Shipping Address', 'surecart'), placeholders: {
        ...
        }, required: this.required || getters.shippingAddressRequired(), loading: getters$1.formLoading(), address: this.address, "show-name": this.showName, "require-name": this.requireName, onScChangeAddress: e => this.updateAddressState(e.detail) }));
    }
    return (index.h("sc-compact-address", { ref: el => (this.input = el), required: this.required || getters.shippingAddressRequired(), loading: getters$1.formLoading(), address: this.address, placeholders: {
        name: this.namePlaceholder,
        country: this.countryPlaceholder,
        city: this.cityPlaceholder,
        line_1: this.line1Placeholder,
...
const ScOrderTaxIdInput = class {
  ...
  render() {
    var _a, _b, _c, _d, _e, _f, _g;
    return (index.h("sc-tax-id-input", { ref: el => (this.input = el), show: this.show, number: (_b = (_a = mutations.state.checkout) === null || _a === void 0 ? void 0 : _a.tax_identifier) === null || _b === void 0 ? void 0 : _b.number, type: ((_d = (_c = mutations.state.checkout) === null || _c === void 0 ? void 0 : _c.tax_identifier) === null || _d === void 0 ? void 0 : _d.number_type) || ((_e = this.taxIdTypesData) === null || _e === void 0 ? void 0 : _e[0]) || 'eu_vat', country: (_g = (_f = mutations.state.checkout) === null || _f === void 0 ? void 0 : _f.shipping_address) === null || _g === void 0 ? void 0 : _g.country, status: this.getStatus(), loading: getters$1.formBusy(), onScChange: e => {
        e.stopImmediatePropagation();
...
const ScShippingChoices = class {
  ...
  async updateCheckout(selectedShippingChoiceId) {
    ...
    try {
      ...
      index$1.speak(wp.i18n.__('Shipping choice updated.', 'surecart'), 'assertive');
      const { total_amount, currency } = mutations.state.checkout;
      /** translators: %1$s: formatted amount */
      index$1.speak(wp.i18n.sprintf(wp.i18n.__('Your order total has changed to: %1$s.', 'surecart'), price.getFormattedPrice({ amount: total_amount, currency })), 'assertive');
    }
    catch (e) {
      console.error(e);
      mutations$3.createErrorNotice(e);
  ...
  render() {
    ...
    })), getters.checkoutIsLocked('selected_shipping_choice') && index.h("sc-block-ui", null)));
  }
};
...
//# sourceMappingURL=sc-compact-address_10.cjs.entry.js.map