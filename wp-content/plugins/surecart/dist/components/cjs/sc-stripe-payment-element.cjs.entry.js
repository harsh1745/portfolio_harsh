...
const getters$2 = require('./getters-60e414dc.js');
...
const ScStripePaymentElement = class {
  ...
  getElementsConfig() {
    ...
    return {
      mode: ((_a = mutations.state.checkout) === null || _a === void 0 ? void 0 : _a.reusable_payment_method_required) ? 'subscription' : 'payment',
