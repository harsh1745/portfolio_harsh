...
import { s as state, o as onChange, r as removeQueryArgs } from './mutations-ecc4ddd1.js';
import { d as updateCheckout, e as expand, f as finalizeCheckout, g as fetchCheckout, h as createCheckout, c as createOrUpdateCheckout } from './index-7f58cf9a.js';
import { c as currentFormState } from './getters-2c9ecd8c.js';
import { s as shippingAddressRequired } from './getters-8221e653.js';
...
import { c as createErrorNotice, r as removeNotice, a as createInfoNotice } from './mutations-79f42351.js';
import { c as clearCheckout } from './mutations-cfd43d3c.js';
import { a as addQueryArgs, g as getQueryArgs } from './add-query-args-f4c5962b.js';
import { s as state$2 } from './watchers-f761bdb6.js';
import './watchers-9b7aebce.js';
import { s as state$3 } from './getters-ed6caaa5.js';
...
const ScOrderConfirmProvider = class {
  ...
  async confirmOrder() {
    ...
    try {
      ...
      if (!!((_c = (_b = state === null || state === void 0 ? void 0 : state.checkout) === null || _b === void 0 ? void 0 : _b.current_upsell) === null || _c === void 0 ? void 0 : _c.permalink)) {
        setTimeout(() => {
          var _a, _b, _c;
          return window.location.assign(addQueryArgs((_b = (_a = state === null || state === void 0 ? void 0 : state.checkout) === null || _a === void 0 ? void 0 : _a.current_upsell) === null || _b === void 0 ? void 0 : _b.permalink, {
            sc_checkout_id: (_c = state.checkout) === null || _c === void 0 ? void 0 : _c.id,
            sc_form_id: state.formId,
          }));
        }, 50);
        clearCheckout();
        return;
      ...
      // get success url.
      const successUrl = ((_e = (_d = state.checkout) === null || _d === void 0 ? void 0 : _d.metadata) === null || _e === void 0 ? void 0 : _e.success_url) || this.successUrl;
      if (successUrl) {
        // set state to redirecting.
        this.scSetState.emit('REDIRECT');
        const redirectUrl = addQueryArgs(successUrl, { sc_order: (_f = state.checkout) === null || _f === void 0 ? void 0 : _f.id });
...
const ScSessionProvider = class {
  ...
  async handleFormSubmit() {
    ...
    if (((_a = state === null || state === void 0 ? void 0 : state.checkout) === null || _a === void 0 ? void 0 : _a.payment_method_required) && (state$2 === null || state$2 === void 0 ? void 0 : state$2.id) === 'stripe' && state$3.config.stripe.paymentElement) {
      // not initialized.
      if (typeof ((_b = state$3 === null || state$3 === void 0 ? void 0 : state$3.instances) === null || _b === void 0 ? void 0 : _b.stripeElements) === undefined) {
    ...
    try {
      ...
      if (['paid', 'processing'].includes((_h = state.checkout) === null || _h === void 0 ? void 0 : _h.status)) {
        this.scPaid.emit();
      }
      if ((_m = (_l = (_k = (_j = state.checkout) === null || _j === void 0 ? void 0 : _j.payment_intent) === null || _k === void 0 ? void 0 : _k.processor_data) === null || _l === void 0 ? void 0 : _l.mollie) === null || _m === void 0 ? void 0 : _m.checkout_url) {
