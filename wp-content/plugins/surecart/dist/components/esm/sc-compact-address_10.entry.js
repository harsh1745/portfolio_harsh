...
import { s as state$1, o as onChange } from './mutations-ecc4ddd1.js';
...
import { l as lockCheckout, b as unLockCheckout } from './mutations-cfd43d3c.js';
import { c as createOrUpdateCheckout } from './index-7f58cf9a.js';
import { f as fullShippingAddressRequired, s as shippingAddressRequired, a as checkoutIsLocked } from './getters-8221e653.js';
  ...
  render() {
    ...
    if (fullShippingAddressRequired() || this.full || this.requireName || this.showName) {
      return (h("sc-address", { exportparts: "label, help-text, form-control, input__base, select__base, columns, search__base, menu__base", ref: el => (this.input = el), label: this.label || wp.i18n.__('Shipping Address', 'surecart'), placeholders: {
        ...
        }, required: this.required || shippingAddressRequired(), loading: formLoading(), address: this.address, "show-name": this.showName, "require-name": this.requireName, onScChangeAddress: e => this.updateAddressState(e.detail) }));
    }
...
//# sourceMappingURL=sc-compact-address_10.entry.js.map