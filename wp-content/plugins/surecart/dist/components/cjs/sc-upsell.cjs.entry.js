...
require('./watchers-51cdd0ea.js');
const store = require('./store-1aade79c.js');
const getters = require('./getters-3a50490a.js');
const mutations = require('./mutations-1809820f.js');
require('./watchers-c190887a.js');
