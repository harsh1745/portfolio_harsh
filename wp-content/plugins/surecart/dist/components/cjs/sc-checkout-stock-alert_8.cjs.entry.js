...
const mutations = require('./mutations-99ffd503.js');
const index$1 = require('./index-fe47fecc.js');
const getters = require('./getters-1e382cac.js');
const getters$1 = require('./getters-60e414dc.js');
const store = require('./store-96a02d63.js');
const mutations$1 = require('./mutations-d667611b.js');
...
const mutations$3 = require('./mutations-82184fe2.js');
const addQueryArgs = require('./add-query-args-17c551b6.js');
const watchers = require('./watchers-d7bdd741.js');
require('./watchers-5c6abc8a.js');
const getters$2 = require('./getters-c41a26c6.js');
...
const ScOrderConfirmProvider = class {
  ...
  async confirmOrder() {
    ...
    try {
      ...
      if (!!((_c = (_b = mutations.state === null || mutations.state === void 0 ? void 0 : mutations.state.checkout) === null || _b === void 0 ? void 0 : _b.current_upsell) === null || _c === void 0 ? void 0 : _c.permalink)) {
        setTimeout(() => {
          var _a, _b, _c;
          return window.location.assign(addQueryArgs.addQueryArgs((_b = (_a = mutations.state === null || mutations.state === void 0 ? void 0 : mutations.state.checkout) === null || _a === void 0 ? void 0 : _a.current_upsell) === null || _b === void 0 ? void 0 : _b.permalink, {
            sc_checkout_id: (_c = mutations.state.checkout) === null || _c === void 0 ? void 0 : _c.id,
            sc_form_id: mutations.state.formId,
          }));
        }, 50);
      ...
      // get success url.
      const successUrl = ((_e = (_d = mutations.state.checkout) === null || _d === void 0 ? void 0 : _d.metadata) === null || _e === void 0 ? void 0 : _e.success_url) || this.successUrl;
      if (successUrl) {
        // set state to redirecting.
        this.scSetState.emit('REDIRECT');
        const redirectUrl = addQueryArgs.addQueryArgs(successUrl, { sc_order: (_f = mutations.state.checkout) === null || _f === void 0 ? void 0 : _f.id });
...
const ScSessionProvider = class {
  ...
  async handleFormSubmit() {
    ...
    try {
      ...
      if (['paid', 'processing'].includes((_h = mutations.state.checkout) === null || _h === void 0 ? void 0 : _h.status)) {
        this.scPaid.emit();
      }
      if ((_m = (_l = (_k = (_j = mutations.state.checkout) === null || _j === void 0 ? void 0 : _j.payment_intent) === null || _k === void 0 ? void 0 : _k.processor_data) === null || _l === void 0 ? void 0 : _l.mollie) === null || _m === void 0 ? void 0 : _m.checkout_url) {
